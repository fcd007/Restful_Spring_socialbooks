package com.ufersacc.socialbooks.resources;
...
import com.ufersacc.socialbooks.services.LivroService;
...
public class LivrosResources {
	...
	public ResponseEntity<Void> adicionarComentario(@PathVariable("id") Long livroId,
		...
		//capturando o usuário autenticado através da autenticação
	...
	public ResponseEntity <List<Comentario>> listarComentarios(
		...
		List<Comentario> comentarios = livroService.listarComenarios(LivroId);
		CacheControl cacheControl = CacheControl.maxAge(20, TimeUnit.SECONDS);
